...
def pengantin1():
    if request.method =='GET':
        ...
        try:
            ...
            query = 'INSERT INTO "pengantin_1" (id_user, name, child_to, mother, father, photo, gender) VALUES (%s,%s, %s, %s, %s, %s, %s)'
        ...
        try:
            ...
            photo = params['photo']
            gender = params['gender']
            query = 'UPDATE "pengantin_1" SET name = %s, child_to = %s, mother= %s, father = %s, photo = %s, gender = %s WHARE id_user = %s'
        ...
        try:
            params = request.get_json()
            id_user = params['id_user']
            query = 'DELETE FROM "pengantin_1" WHERE id_user = %s'
            params = (id_user,)
